...
#if CONFIG_WIFI_PROV_SECURITY_VERSION_2
#if CONFIG_WIFI_PROV_SEC2_DEV_MODE
...
static esp_err_t example_get_sec2_salt(const char **salt, uint16_t *salt_len) {
    ...
    *salt_len = sizeof(sec2_salt);
    return ESP_OK;
#elif CONFIG_WIFI_PROV_SEC2_PROD_MODE
    ...
    if (event_base == WIFI_PROV_EVENT) {
        switch (event_id) {
            ...
            case WIFI_PROV_CRED_FAIL: {
                 ...
                 * This is enabled by the CONFIG_WIFI_RESET_PROV_MGR_ON_FAILURE configuration.
...
static void wifi_prov_print_qr(const char *name, const char *username, const char *pop, const char *transport) {
    ...
    char payload[150] = {0};
    if (pop) {
#if CONFIG_WIFI_PROV_SECURITY_VERSION_1
        snprintf(payload, sizeof(payload), "{\"ver\":\"%s\",\"name\":\"%s\""
                                           ",\"pop\":\"%s\",\"transport\":\"%s\"}",
                 PROV_QR_VERSION, name, pop, transport);
#elif CONFIG_WIFI_PROV_SECURITY_VERSION_2
        snprintf(payload, sizeof(payload), "{\"ver\":\"%s\",\"name\":\"%s\""
...
#ifdef CONFIG_WIFI_PROV_ENABLE_APP_CALLBACK
...
#ifdef CONFIG_WIFI_RESET_PROV_MGR_ON_FAILURE
        .wifi_prov_conn_cfg = {
            .wifi_conn_attempts = CONFIG_WIFI_PROV_MGR_CONNECTION_CNT
        }
#endif
    };
...
#ifdef CONFIG_WIFI_PROV_SECURITY_VERSION_1
...
#ifdef CONFIG_WIFI_REPROVISIONING
